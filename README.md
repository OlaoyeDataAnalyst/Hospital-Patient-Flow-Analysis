[README.md](https://github.com/user-attachments/files/30829690/README.md)
...
├── 01_Hospital_Patient_Flow_EDA.ipynb             # Python EDA with 10 clinical visualizations
├── 02_Hospital_SQL.sql                            # 11 SQL queries including CTEs & window functions
├── 03_Hospital_Excel.xlsx                         # Pivot tables, collection rate analysis & KPI sheet
├── 04_Hospital_Dashboard.pdf                      # Power BI dashboard with drill-through
├── 05_Hospital_Patient_Flow_Analysis_Report.docx  # Written findings & operational recommendations
...
## 📸 Dashboard Preview
*See **04_Hospital_Dashboard.pdf** for the full Power BI dashboard featuring:*
...
## 👩‍💻 Analyst
**Olaoye Abosede Esther** — Healthcare Data Analyst
...
*© 2026 Olaoye Abosede Esther. All rights reserved.*
