-- Create a new database for hospital patient flow
CREATE DATABASE IF NOT EXISTS lagos_hospital;

-- ================================================
-- HOSPITAL PATIENT FLOW & RESOURCE 
-- ANALYSIS
...
-- ================================================
-- Total admissions and average length 
...
-- ================================================
-- Readmission rate per department
...
-- ================================================
-- Revenue gap: total billed vs total 
...
-- ================================================
-- Patients with length of stay > 14 days
...
-- ================================================
-- Count of patients with stay > 14 days
-- ================================================
...
-- ================================================
-- Department with most long stay patients
-- ================================================
...
-- ================================================
-- Mortality rate by department and year
...
-- ================================================
-- Follow up: Overall mortality rate
-- by department across all years combined
-- ================================================

-- ================================================
-- Overall mortality rate by department
...
-- ================================================
-- Rank departments by average bill 
...
-- ================================================
-- CTE: Top 5 wards by patient load 
-- each year
-- ================================================
